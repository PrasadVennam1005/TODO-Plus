...
class MarkTodoIncompleteIntention : IntentionAction {

    override fun getText(): String = "Mark DONE as Incomplete (TODO)"
    ...
    override fun isAvailable(project: Project, editor: Editor?, file: PsiFile?): Boolean {
        ...
        return text.contains("DONE", ignoreCase = true) || text.contains("COMPLETED", ignoreCase = true)
    }
    ...
    override fun invoke(project: Project, editor: Editor?, file: PsiFile?) {
        ...
        if (todoItem != null) {
            ...
            val updatedText = currentText.replace(Regex("(?i)(//|#|--|/\\*)\\s*(DONE|COMPLETED)\\b"), "$1 TODO")
